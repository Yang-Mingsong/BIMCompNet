...
def mesh_net_main():
    ...
    for epoch in range(1, obj_Config['num_epochs'] + 1):
        ...
        if epoch % obj_Config['valid_freq'] == 0:
            tester.test(epoch, device, obj_Config['test_batch_size'], obj_Config['save_path'])
...
def vox_net_main():
    ...
    for epoch in range(1, vox_Config['num_epochs'] + 1):
        ...
        if epoch % vox_Config['valid_freq'] == 0:
            tester.test(epoch, device, vox_Config['test_batch_size'], vox_Config['save_path'])
...
def dgcnn_main():
    ...
    for epoch in range(1, ply_Config['num_epochs'] + 1):
        ...
        if epoch % ply_Config['valid_freq'] == 0:
            tester.test(epoch, device, ply_Config['test_batch_size'], ply_Config['save_path'])
